...
import { listProjects, listUsers, listTasks } from "../services/api.jsx";
      ...
      <div style={{ marginBottom: "2rem" }}>
        ...
        {user?.tenant && (
          <p style={{ margin: 0, color: "#666", fontSize: "0.95rem" }}>
            Welcome to <strong>{user.tenant.name}</strong>
          </p>
        )}
      </div>
            ...
            <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
              ...
              <button
                ...
                onClick={() => {
                  ...
                  if (newProjectForm)
                    navigate("/projects", {
                      state: { newProject: newProjectForm },
                    });
                }}
              >
                + New Project
                  ...
                  >
                    ...
                    >
                      <span
                        style={{
                          backgroundColor:
                            project.status === "active" ? "#4CAF50" : "#999",
                          color: "white",
